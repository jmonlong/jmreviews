...
**Control-FREEC** aims at predicting copy number variation along with LOH [@Boeva2011;@Boeva2012].
It corrects for GC bias and mappability and, in its second iteration, uses both the RD and allelic imbalance to call CNVs.
Both germline and somatic variants can be called.
For cancer, pairs are not necessary and the method can also estimate the stromal contamination or ploidy

It provides a mappability track that can be used to exclude low-mappability regions.
...
**Control-FREEC** [@Boeva2011;@Boeva2012] aim at predicting copy number variation along with LOH.
It corrects for GC bias and mappability and, in its second iteration, uses both the RD and allelic imbalance to call CNVs.
Both germline and somatic variants can be called.
For cancer, pairs are not necessary and the method can also estimate the stromal contamination or ploidy
...
| 2011 | Control-FREEC [@Boeva2011]            | RD+AI        | CNV and contamination                   | single, pair  |  NA                    |
