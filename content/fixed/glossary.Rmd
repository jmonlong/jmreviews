...
A type of **inflammatory bowel disease** caused by a combination of environmental, immune and bacterial factors in genetically susceptible individuals. 
No medication or surgery can cure Crohn's disease.
The unregulated inflammation is thought to be caused by a disfunctional immune response.

About 40% of cases show inflammation of the ileum (final section of the small intestine in) and 30-40% inflammation of the small intestine, often in segments (skip lesions). 
About 20% of cases have skip lesions of the colon (Crohn's colitis).
Less than 10% have perianal inflammation.

More female are affected.
...
Lower than normal level of oxygen.

# Inbreeding coefficient

The probability that two alleles are the same, i.e identical by descent.
...
Recycles iron (among other things).
...
Malignant tumor originating from cells of connective tissue. Typically grouped into bone sarcomes and soft-tissue sarcomas. Symptoms include a lump.
...
It's an autoimmune disease where T-cells infiltrate the colon which cause inflammation and ulcers in the colon and rectum.
The main symptoms include abdominal pain and diarrhea mixed with blood.
About 40-50% of the inflammation is located in the rectal/sigmoid area (proctitis) that can then spread.
