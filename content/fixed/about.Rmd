...
To minimize this website being found, I added a `robots.txt` file, edited the `head.html` in the theme to include a new `<meta>` tag, and am not using the *master* branch on github anymore.
